...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { description: @experience.description, title: @experience.title } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { description: @experience.description, title: @experience.title } }
