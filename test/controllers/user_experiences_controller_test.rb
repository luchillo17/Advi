...
class UserExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_experience" do
    assert_difference('UserExperience.count') do
      post user_experiences_url, params: { user_experience: { experience_id: @user_experience.experience_id, expertise_time: @user_experience.expertise_time, user_id: @user_experience.user_id } }
    end
  ...
  test "should update user_experience" do
    patch user_experience_url(@user_experience), params: { user_experience: { experience_id: @user_experience.experience_id, expertise_time: @user_experience.expertise_time, user_id: @user_experience.user_id } }
